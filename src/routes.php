...
/**
 * Connect routes with ADMIN_PANEL permission(for security) and 'Idea\Ideaadmin\Controllers' namespace
 * and '/admin' url.
 */
Route::group([
    ...
    Route::post(config('laraadmin.adminRoute') . '/module_field_lang_active', 'FieldController@module_field_lang_active_ajax');
    ...
    /* ================== Configuration ================== */
    Route::resource(config('laraadmin.adminRoute') . '/la_configs', '\App\Http\Controllers\Backend\BackendConfigController');
