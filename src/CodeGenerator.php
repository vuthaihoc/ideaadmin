...
class CodeGenerator
{
    ...
    public static function createController($config, $comm = null)
    {
        ...
        BackendHelper::log("info", "Creating controller...", $comm);
        ...
        file_put_contents(base_path('app/Http/Controllers/Backend/' . $config->controllerName . ".php"), $md);
    }
    ...
    public static function createModel($config, $comm = null)
    {
        ...
        BackendHelper::log("info", "Creating model...", $comm);
    ...
    public static function createViews($config, $comm = null)
    {
        ...
        BackendHelper::log("info", "Creating views...", $comm);
        // Create Folder
    ...
    public static function appendRoutes($config, $comm = null)
    {
        ...
        BackendHelper::log("info", "Appending routes...", $comm);
    ...
    public static function addMenu($config, $comm = null)
    {
        ...
        BackendHelper::log("info", "Appending Menu...", $comm);
        ...
        // $md = str_replace("<!-- BackendMenus -->", $menu, $md);
    ...
    public static function generateMigration($table, $generate = false, $comm = null)
    {
        ...
        BackendHelper::log("info", "Model:\t   " . $modelName, $comm);
        BackendHelper::log("info", "Module:\t   " . $moduleName, $comm);
        BackendHelper::log("info", "Table:\t   " . $dbTableName, $comm);
        BackendHelper::log("info", "Migration: " . $migrationName . "\n", $comm);
        ...
        if($generate) {
            ...
            if(isset($module)) {
                BackendHelper::log("info", "Module exists :\t   " . $moduleName, $comm);
                ...
                if($fileExists) {
                    BackendHelper::log("info", "Replacing old migration file: " . $fileExistName, $comm);
                ...
                BackendHelper::log("error", "Module " . $moduleName . " doesn't exists; Cannot generate !!!", $comm);
            }
        }
        ...
        try {
            BackendHelper::log("line", "Creating migration...", $comm);
        ...
        BackendHelper::log("info", "Migration done: " . $migrationFileName . "\n", $comm);
    }
