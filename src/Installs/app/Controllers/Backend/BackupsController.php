...
class BackupsController extends Controller
{
	...
	public function create_backup_ajax(Request $request)
	{
		if(Module::hasAccess("Backups", "create")) {
			...
			if(BackendHelper::getLineWithString2($outputStr, "Copying ") == -1) {
				if(BackendHelper::getLineWithString2($outputStr, "mysqldump: No such file or directory") != -1) {
				...
				$dataStr = BackendHelper::getLineWithString2($outputStr, "Copying ");
