				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\Idea\Ideaadmin\Controllers\MenuController@store', 'id' => 'menu-custom-form']) !!}
				...
				<div class="dd" id="menu-nestable">
					<ol class="dd-list">
						@foreach ($menus as $menu)
							<?php echo BackendHelper::print_menu_editor($menu); ?>
						@endforeach
					</ol>
				</div>
			</div>
...
<div class="modal fade" id="EditModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => ['\Idea\Ideaadmin\Controllers\MenuController@update', 1], 'id' => 'menu-edit-form']) !!}
