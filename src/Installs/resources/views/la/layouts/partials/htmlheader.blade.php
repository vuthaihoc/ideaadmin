<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ BackendConfigs::getByKey('sitename') }}</title>
    ...
    -->
    <link href="{{ asset('la-assets/css/skins/'.BackendConfigs::getByKey('skin').'.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
