		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				@if(BackendConfigs::getByKey('show_messages'))
				...
				@endif
				@if(BackendConfigs::getByKey('show_notifications'))
				<!-- Notifications Menu -->
				...
				@endif
				@if(BackendConfigs::getByKey('show_tasks'))
				<!-- Tasks Menu -->
				...
				@endif
				@if(BackendConfigs::getByKey('show_rightsidebar'))
