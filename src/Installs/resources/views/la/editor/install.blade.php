...
@section("contentheader_title", "Backend Code Editor")
@section("contentheader_description", "Installation instructions")
@section("section", "Backend Code Editor")
@section("sub_section", "Not installed")
@section("htmlheader_title", "Install Backend Code Editor")
...
<div class="box">
	...
	<div class="box-body">
		<p>IdeaAdmin Code Editor does not comes inbuilt now. You can get it by following commands.</p>
		<pre><code>composer require idea/laeditor</code></pre>
