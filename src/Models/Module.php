 ...
 *
 * Most important Model of IdeaAdmin which looks after Module, ModuleField Generation.
...
class Module extends Model
{
    ...
    public static function generateBase($module_name, $icon)
    {
        ...
        $names = BackendHelper::generateModuleNames($module_name, $icon);
    ...
    public static function generate($module_name, $module_name_db, $view_col, $faIcon = "fa-cube", $fields)
    {
        ...
        $names = BackendHelper::generateModuleNames($module_name, $faIcon);
    ...
    public static function format_fields($module_name, $fields)
    {
        ...
        foreach($fields as $field) {
            ...
            if(BackendHelper::is_assoc_array($field)) {
                $obj = (object)$field;
     ...
     * Used in IdeaAdmin generated Controllers for store and update.
    ...
    public static function getListingColumns($module_id_name, $isObjects = false)
    {
        ...
        foreach($listing_cols as $col) {
            if(Module::hasFieldAccess($module->id, $col['id']) || $module_id_name == "History_contacts" || $module_id_name == "Real_estates") {
                if($isObjects) {
