 ...
 *
 * Command to put latest development and changes of project into IdeaAdmin package.
 * [For IdeaAdmin Developer's Only]
 */
class Packaging extends Command
{
    ...
    protected $description = '[Developer Only] - Copy IdeaAdmin-Dev files to package: "idea/ideaadmin"';
    ...
    /**
     * Copy Project changes into IdeaAdmin package.
     *
     * @return mixed
     */
    public function handle()
    {
        ...
        $from = base_path();
        $to = base_path('vendor/idea/ideaadmin/src/Installs');
        ...
        $this->replaceFolder($from . "/app/Http/Controllers/Backend", $to . "/app/Controllers/Backend");
        ...
        // la-assets
        $this->line('Exporting IdeaAdmin Assets...');
