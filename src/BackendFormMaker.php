        ...
        if(Module::hasFieldAccess($module->id, $module->fields[$field_name]['id'], $access_type = "write")) {
            ...
            switch($field_type->name) {
                ...
                case 'Dropdown':
                    ...
                    if($popup_vals != "") {
                        $popup_vals = BackendFormMaker::process_values($popup_vals);
                    } else {
                        $popup_vals = array();
                    }
...
//                    unset($params['data-rule-maxlength']);
                ...
                case 'Taginput':
                    ...
                    $default_val = BackendFormMaker::process_values($default_val);
...
//                    }
     ...
     **/
    // $values = BackendFormMaker::process_values($data);
        ...
        if(Module::hasFieldAccess($module->id, $module->fields[$field_name]['id'], $access_type = "view")) {
            ...
            switch($field_type->name) {
                ...
                case 'Decimal':
                    ...
                    break;
                case 'Dropdown':
                    $values = BackendFormMaker::process_values($fieldObj['popup_vals']);
    ...
    public static function form($module, $fields = [])
    {
        ...
        foreach($fields as $field) {
            ...
            $out .= BackendFormMaker::input($module, $field);
        }
        return $out;
    }
